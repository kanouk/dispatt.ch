-- Update create_default_user_platforms to be idempotent and add Apple Podcasts for existing users
...
BEGIN
  ...
  ELSE
    -- For existing users, add Apple Podcasts if it doesn't exist
